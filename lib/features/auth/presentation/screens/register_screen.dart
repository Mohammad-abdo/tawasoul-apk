...
import 'package:mobile_app/features/auth/presentation/widgets/phone_input_field.dart';
import 'package:mobile_app/features/auth/presentation/widgets/relation_type_dropdown.dart';
...
class _RegisterScreenState extends State<RegisterScreen> {
  ...
  Future<void> _handleSubmit() async {
    ...
    if (_formKey.currentState?.saveAndValidate() ?? false) {
      ...
      try {
        final success = await authCubit.sendOtp(
        ...
        if (success) {
          ...
          ScaffoldMessenger.of(context).showSnackBar(
            SnackBar(content: Text(authCubit.state.error ?? 'حدث خطأ'), backgroundColor: AppColors.error),
          );
        }
      } catch (e) {
